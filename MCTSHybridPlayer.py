...
class MCTSHybridPlayer(PlayerBase):
  """
  Monte-Carlo Tree Search Player with hybrid strategy:
    Each step gets a node, and at the end explore up to
    four levels into the tree to find the 1-4 steps for the next move
  """
  # Takes 2 arguments:
  argcount = 2
