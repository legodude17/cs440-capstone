...
class MCTSPlayer(PlayerBase):
  """
  Monte-Carlo Tree Search Player with step strategy:
    Each step gets a node, return the best step from the current position
    Changing steps into moves is handled by the PlayerBase class
  """
  # Takes 2 arguments:
  argcount = 2
